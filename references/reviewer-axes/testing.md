# Testing
Gate: on when the diff changes test files, fixtures, mocks, or harness code, or when it changes runtime behavior (new branches, state mutation, error handling, control flow) without corresponding test changes.
