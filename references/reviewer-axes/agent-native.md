# Agent-native
Gate: on when the diff touches skills, agent definitions, prompts, tool definitions, MCP configuration, slash commands, or hooks. Adapted from Every's `ce-code-review`, agent-native reviewer.
